...
export default function Movie({data}:props){
    const backdropPath = `https://image.tmdb.org/t/p/w500${data.poster_path}`
    return (
        <main>
            <Image src={backdropPath} alt={`${data.title} poster`} fill/>
        </main>
    )
}
